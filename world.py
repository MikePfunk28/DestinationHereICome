...
locations = {
    'player_hideout': {
        'name': "Cramped Bolt-hole", 'description': "Your small, stale hideout.",
        'description_level_1': "Your hideout, reinforced and cleaner.",
        'exits': {'west': 'shambles_alley'}, 'items': [], 'npcs': [], 'is_hideout': True,
    },
    'old_sewer_tunnel': {
        'name': "Old Sewer Tunnel", 'description': "Damp, dark tunnel. Smells awful.",
        'exits': {'up': 'shambles_square'}, 'items': ['sealed_package'],
        'npcs': [Enemy("Diseased Rat", 15, 6, 1, "Bloated, red-eyed rat.", loot=['rat_tail'])]
    },
    'shambles_square': {
        'name': "Shambles Square", 'description': "Muddy, chaotic market square.",
